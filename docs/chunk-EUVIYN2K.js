...
var H = null,
  St = !1;
function ks(n) {
  H || ((H = Ds() || {}), (St = H.style ? "WebkitAppearance" in H.style : !1));
  let e = !0;
  return (
    H.style &&
      !Cs(n) &&
...
var At = "",
  $e = class {
    ...
    visitGroup(e, t) {
      ...
      return (
        (t.currentTime = i), { type: S.Group, steps: r, options: Y(e.options) }
      );
    }
    visitAnimate(e, t) {
    ...
    visitAnimateChild(e, t) {
      return t.depCount++, { type: S.AnimateChild, options: Y(e.options) };
    }
    visitAnimateRef(e, t) {
      return {
        type: S.AnimateRef,
